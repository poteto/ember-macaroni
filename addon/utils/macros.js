...
*/
function findFromCollectionByValue(collectionKey, propName, value) {
...
*/
function rejectFromCollectionByKey(collectionKey, propName, valueKey) {
  return computed(`${collectionKey}.@each.${propName}`, valueKey, {
    get() {
      return emberArray(get(this, collectionKey))
...
*/
function filterFromCollectionByKey(collectionKey, propName, valueKey) {
  return computed(`${collectionKey}.@each.${propName}`, valueKey, {
    get() {
      return emberArray(get(this, collectionKey))
...
*/
function filterCollectionByContains(collectionKey, propName, values = []) {
  return computed(`${collectionKey}.@each.${propName}`, {
    get() {
      return emberArray(get(this, collectionKey))
...
*/
function reduceCollectionByKey(collectionKey, dependentKey, startValue = 0) {
...
*/
function getPropertiesByKeys(...dependentKeys) {
...
*/
function ifThenElseWithValues(conditionalKey, trueValue = true, falseValue = false) {
